...
|--------|-------------|------------------|
| [🔍 Microscopic Image Analysis](https://github.com/Ainaraharison/ainaraharison.github.io.git) | Exploration of mineral images using PCA, clustering, and contrast inversion | Python, NumPy, Scikit-learn, Matplotlib |
